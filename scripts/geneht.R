...
if (sys.nframe() == 0){
  ...
  draw(make_gene_heatmap3(all_df, all_gene_df, "2Gy_vs_0Gy", "all", category_names, rownames_fs = 12))
  draw(make_gene_heatmap3(all_df, all_gene_df, "6Gy_vs_0Gy", "all", category_names, rownames_fs = 12))
  
  draw(make_gene_heatmap3(unique_df, unique_gene_df, "2Gy_vs_0Gy", "unique", category_names, rownames_fs = 12))
  draw(make_gene_heatmap3(unique_df, unique_gene_df, "6Gy_vs_0Gy", "unique", category_names, rownames_fs = 12))

  draw(make_gene_heatmap3(common_df, common_gene_df, "2Gy_vs_0Gy", "common", category_names, rownames_fs = 12))
  draw(make_gene_heatmap3(common_df, common_gene_df, "6Gy_vs_0Gy", "common", category_names, rownames_fs = 12))
  dev.off()
}
